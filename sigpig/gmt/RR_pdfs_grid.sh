...
gmt begin pdfs_$VEL_RANGE png
	...
	gmt basemap -Rk694.150000/694.448000/5155.400000/5155.898000 -JU+10/? -Baf -BWeNs+t"Event PDF Locations Vp=$VEL_RANGE (SSST)"
	...
	# trim and plot the colorbar
	gmt colorbar -C -DJMR+o11.0c/6+w10c/0.3c -B1000 -Bx+l"PDF sum" # -G0/50000
