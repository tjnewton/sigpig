...
% theEvent       = which('srEvent_TN.mat');
theStation     = which('srStation_TN.mat');
theElevation   = which('srElevation_TN.mat');
% Doug's velocity model
theModel       = which('srModel_2m_0.6-0.75_TN.mat');
% reduced velocity model
% theModel       = which('srModel_2m_0.5-0.65_TN.mat');
% theModel       = which('srModel_2m_0.4-0.55_TN.mat');
% theModel       = which('srModel_2m_0.3-0.45_TN.mat');
% theModel       = which('srModel_2m_OSOS_0.04.mat');
