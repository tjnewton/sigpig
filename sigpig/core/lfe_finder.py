...
def sort_party(party, n, detection_files_path, main_trace, plot=False,
               save_detections=False, title=""):
    """ Takes in an EQcorrscan party object and sorts the detections
